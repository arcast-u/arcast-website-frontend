...
//    // Use Next.js hooks to retrieve the query parameter named "setup"
//   //  const searchParams = useSearchParams();
//   //  const setup = searchParams.get("setup");
//    const setup = localStorage.getItem('selectedStudio')
...
//      ];
//    } else {
//      // Fallback/default images if no setup parameter is provided
//      carouselImages = [
//        "/images/setup2-1.webp",
//        "/images/setup2-2.webp",
//        "/images/setup2-3.webp",
...
//  return (
//   <Suspense fallback={<div className="w-full h-[39.4vh] lg:h-screen bg-gray-200" />}>
//   <CarouselContent />
// </Suspense>
//  )
// };
