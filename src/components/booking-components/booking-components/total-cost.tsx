...
const TotalCost = ({ description, total, onContinue }: TotalCostProps) => (
  <footer className=" bg-zinc-50 shadow-lg border border-[#989898] rounded-2xl border-opacity-50">
    <div className="flex justify-between items-center mx-auto py-4 px-6 font-nunitoSans 3xl:py-[23px] w-full 3xl:px-8">
      ...
      <button 
        onClick={onContinue}
        className="flex-1 shrink w-fit px-5 py-3 3xl:px-6 3xl:py-4 text-sm leading-[19.1px] 3xl:text-base 3xl:leading-[21.82px] font-medium text-center whitespace-nowrap bg-[#FF8C42] rounded-lg  shadow-[0px_4px_4px_rgba(0,10,31,0.2)] text-[#FCFCFC] border-[1px] border-[#FFC49D] hover:scale-105"
