  ...
  return (
    <div className="w-full">
      <button
        ...
        className="flex flex-wrap relative items-center jusify-between px-4 py-3 mt-5 3xl:px-6 3xl:py-5 3xl:mt-6 w-full rounded-xl bg-[#F5F5F7] "
      ...
      {showCalendar && (
        <div className="bg-[#F5F5F7] w-full shadow-lg px-6 py-[22px] rounded-lg mt-2">
              ...
              {week.map((day, idx) => (
                <div
                  ...
                  className={`py-1.5 px-2 font-nunitoSans font-500 text-lg leading-7 3xl:text-2xl 3xl:leading-[32.74px] rounded-lg transition ${
                    ...
                    day === tempDate?.getDate() ? "bg-[#333333] shadow-lg text-[#F5F5F7] cursor-pointer" : "hover:bg-gray-200 cursor-pointer"
                  }`}
