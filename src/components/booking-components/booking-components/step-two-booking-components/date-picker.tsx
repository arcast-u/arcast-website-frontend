...
const DatePicker = () => {
  const [date, setDate] = useState<Date | undefined>(new Date(2025, 0, 25)); 
    ...
    <div className="flex flex-col items-start gap-2">
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button className={`flex items-center justify-between hover:bg-[#F5F5F7] mt-4 3xl:mt-5 w-full rounded-xl bg-[#F5F5F7] ${isOpen ? "border-[0.5px] border-[#5081FF]" : ""}`}>
