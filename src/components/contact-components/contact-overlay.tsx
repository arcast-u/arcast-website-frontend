                  ...
                  <div className="space-y-3 flex-1">
                    ...
                    <div className="pt-5 pb-14 3xl:pb-0 3xl:pt-4">
                      ...
                      <div className="space-y-2 3xl:space-y-4 text-base leading-[21.82px] font-normal 3xl:text-lg 3xl:leading-[24.55px]">
                        <a href="mailto:hello@arcastdubai.com" className="flex items-center text-[#333333] hover:text-[#FF8C42] hover:underline">
                          <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          </svg>
                          hello@arcastdubai.com
                        </a>
                        <a href="tel:+971658365736" className="flex items-center text-[#333333] hover:text-[#FF8C42] hover:underline">
                          <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                          </svg>
                          +971 6583657364
                        </a>
                        <a href="https://wa.me/971874924799" className="flex items-center text-[#333333] hover:text-[#FF8C42] hover:underline">
