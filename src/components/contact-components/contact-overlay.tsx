          ...
          >
            ...
            <div className='font-nunitoSans h-full flex flex-col'>
              ...
              <div className='flex-1 flex flex-col h-full'>
                <div className='w-[87%]'>
                  <h2 className='mb-2 3xl:mb-3 header-text'>Contact Us</h2>
                  <p className='text-[#333333] font-normal text-sm 3xl:text-lg 3xl:leading-[24.55px] leading-[19.1px] mb-2'>
                    Whether you&apos;re ready to record or just have questions,
                    we&apos;re here to help.
                  </p>
                ...
                <form
                  ...
                  className='flex-1 flex flex-col h-full mt-6'
                >
                  <div className='space-y-3 flex-1'>
                    ...
                    <div className='grid grid-cols-4 gap-4 relative'>
                      <button
                        ...
                        className='flex gap-1 items-center  pr-3 3xl:pr-4 pl-4 3xl:pl-6 whitespace-nowrap rounded-md focus:outline-none focus:ring-2 focus:ring-[#FF8C42] bg-[#F5F5F7] text-[#333333] '
                      >
                    ...
                    <div className='pt-5 pb-14 3xl:pb-0 3xl:pt-4'>
                      <h2 className='header-text mb-3 3xl:mb-4'>
                        Reach Out To Us
                      </h2>
