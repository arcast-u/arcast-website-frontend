...
const DubaiStudioLocation = () => {
  ...
  return (
    <div className=' py-10  lg:py-20 w-full'>
      <div className='max-w-[1728px] px-[21px] md:px-10 3xl:px-[100px] h-full flex flex-col items-center mx-auto text-[#333333]'>
        <h2 className='text-[32px] leading-[41.7px] 3xl:text-5xl 3xl:leading-[62.54px] font-medium font-hankenGrotesk'>
          Find Our Studio in Dubai
        </h2>

        <div className='grid grid-cols-1 font-nunitoSans md:grid-cols-2 xl:grid-cols-3 gap-6 mt-6 w-full'>
          {/* Location Details */}
          <div className=' flex flex-col gap-6 h-full'>
            <div className='bg-[#F5F5F7] flex-grow p-6 3xl:py-10 3xl:px-[60px] rounded-xl shadow-md w-full'>
              <h3 className='text-2xl leading-8 font-medium text-[#333333]'>
                Loft Offices 2
              </h3>
              <p className='text-[#989898] font-medium text-base leading-6 mt-1'>
              ...
              <div className='mt-4 flex items-center space-x-2 text-orange-500'>
                ...
                <span className='font-medium text-xl leading-[27px] 3xl:text-2xl 3xl:leading-8 text-[#333333]'>
                  Nearby
                </span>
              </div>
              <p className='text-[#989898] font-medium text-base leading-6 3xl:text-xl 3xl:leading-7 3xl:mt-3 mt-1'>
                OSN, Avani+ Palm View Dubai Hotel & Suites
              </p>
              <div
                onTouchStart={onTouchStart}
                onTouchMove={onTouchMove}
                onTouchEnd={onTouchEnd}
                className='w-full relative flex-grow mt-6 p-0'
              >
                <Image
            ...
            <div className='bg-[#F5F5F7] p-6 3xl:py-10 3xl:px-[60px] rounded-xl shadow-md text-center'>
              <h3 className='text-lg 3xl:text-[40px] font-medium text-[#333333]'>
                Opening hours
              </h3>
              <div className='grid grid-cols-2 text-[#989898] mt-7 gap-4'>
                <div>
                  <TbClockHour4 className='size-6 3xl:size-10 text-[#FF8C42] mx-auto' />
                  <p className='text-sm 3xl:text-xl 3xl:leading-7 leading-[19.1px] mt-2'>
                    Mon-Fri
                  </p>
          ...
          <div className='bg-[#F5F5F7] h-full pt-8 pb-6 px-6 3xl:py-10 3xl:px-[60px] relative rounded-xl shadow-md flex flex-col border items-center'>
            ...
            <div className='absolute bottom-0 bg-gradient-to-t w-full flex flex-col h-[45%] text-center justify-center from-[#F5F5F7] via-[#F5F5F7] to-transparent '>
              <p className='text-lg 3xl:text-[40px] font-semibold text-[#333333] mt-36'>
                Studio location
              </p>
              <a
          ...
          {/* contact & transport mobile */}
          <div className='bg-[#F5F5F7] p-6 3xl:py-10 3xl:px-[60px] rounded-xl shadow-md xl:hidden h-full'>
            <h3 className='text-lg 3xl:text-[40px] font-medium text-[#333333] text-center'>
              Contact
            </h3>
          ...
          {/* parking mobile*/}
          <div className='bg-[#F5F5F7] p-6 3xl:py-10 3xl:px-[60px] rounded-xl flex-grow shadow-md xl:hidden'>
            <h3 className='text-lg 3xl:text-[40px] font-medium text-[#333333] text-center '>
              Parking & Transport
            </h3>
            <div className='mt-4 3xl:mt-10 text-sm leading-5 3xl:text-xl 3xl:leading-7 left-7 space-y-3 text-[#333333]'>
              <p className='bg-[#FCFCFC] py-[14px] lg:py-6 px-4 rounded-lg'>
                <span className='text-[#989898]'>Paid parking:</span> Media City
                parking
              </p>
              <p className='bg-[#FCFCFC] py-[14px] lg:py-6 px-4 rounded-lg'>
                <span className='text-[#989898]'>Closest Metro:</span> Dubai
                Internet City Station
              </p>
              <p className='bg-[#FCFCFC] py-[14px] lg:py-6 px-4 rounded-lg'>
                <span className='text-[#989898]'>Closest Tram:</span> The Palm
                Jumeirah
              </p>
              <p className='bg-[#FCFCFC] py-[14px] lg:py-6 px-4 rounded-lg'>
                <span className='text-[#989898]'>Closest Bus:</span> Infotech
                Dubai Internet City 2
              </p>
            </div>
          </div>
          {/* contact & transport desktop */}
          <div className='hidden xl:flex flex-col gap-6 h-full'>
            ...
            <div className='bg-[#F5F5F7] p-6 3xl:py-10 3xl:px-[60px] rounded-xl flex-grow shadow-md'>
              ...
              <div className='mt-4 3xl:mt-10 text-sm leading-5 3xl:text-xl 3xl:leading-7 left-7 space-y-3 text-[#333333]'>
                <p className='bg-[#FCFCFC] py-[14px] lg:py-6 px-4 rounded-lg'>
                  <span className='text-[#989898]'>Paid parking:</span> Media
                  City parking
                </p>
                <p className='bg-[#FCFCFC] py-[14px] lg:py-6 px-4 rounded-lg'>
                  <span className='text-[#989898]'>Closest Metro:</span> Dubai
