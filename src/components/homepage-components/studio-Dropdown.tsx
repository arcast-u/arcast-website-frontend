...
const setups = [
  ...
  //   available: true,
  // },
  { id: 0, name: 'Setup 1', image: '/images/newstudio2.png', available: true },
  // { id: 3, name: 'Setup 3', image: '/images/studio3.jpg', available: false },
  { id: 1, name: 'Setup 2', image: '/images/newstudio3.png', available: true },
  // { id: 5, name: 'nil', available: true },
  // { id: 5, name: 'Setup 5', image: '/images/studio5.jpg', available: false },
  { id: 2, name: 'Setup 3', image: '/images/newstudio6.png', available: true },
  // { id: 7, name: 'Setup 7', image: '/images/studio7.jpg', available: false },
  { id: 3, name: 'Setup 4', image: '/images/newstudio8.png', available: true },
