...
const setups = [
  { id: 1, name: "Mobile Studio", image: "/images/studio1.webp", available: true },
...
const ChooseSetup = () => {
  ...
  return (
    <section className="absolute h-screen pb-20   overflow-y-auto lg:h-auto bg-[#FCFCFC] rounded-b-xl md:top-12 top-14 lg:top-14 3xl:top-16 flex flex-wrap lg:flex-nowrap justify-between left-0 w-full px-10 py-16">
