...
export const ProfessionalStudioHeader= () => {
  return (
    <header className="flex gap-5 justify-between mx-auto px-[21px] lg:px-10 3xl:px-[100px] lg:mt-10  md:mb-[51px] lg:mb-0 3xl:mt-20 3xl:mb-[120px] w-full text-[#333333]">
