...
function Hero() {
  ...
  return (
    <div className="h-screen max-w-[1728px] mx-auto flex flex-col bg-[url('/images/hero-bg.webp')] bg-cover">
        <NavigationBar/>
        <div className='w-[85vw] mx-[21px] lg:w-[55vw] lg:mx-10 mb-10 3xl:mx-[100px]  mt-auto'>
            <p className='text-[#FCFCFC] font-hankenGrotesk font-medium text-3xl leading-[39.09px] xl:text-4xl xl:leading-[45px] 3xl:text-[52px] 3xl:leading-[67.76px]'>Where Dubai's Bold Voices Come to Life. Dubai&apos;s World-Class  Podcast Studio.</p>
