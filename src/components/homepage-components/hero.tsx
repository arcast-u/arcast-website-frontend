...
function Hero() {
  ...
  return (
    <div className="h-screen w-full mx-auto flex flex-col md:bg-[url('/images/Herosectionmd.png')] ipadPro:bg-[url('/images/Herosectionmd.png')] lg:bg-[url('/images/Herosection.png')] bg-[url('/images/heromobile.png')] bg-cover bg-no-repeat border-0 outline-none">
        <NavigationBar/>
