        ...
        <div className='max-w-[1728px] h-full flex items-center mx-auto justify-center'>
          <div className='lg:w-[38%] md:w-[60%] m-10 md:m-auto font-hankenGrotesk w-full text-center text-[#F0F2F6]'>
            ...
            <p className='text-xl 3xl:text-[28px] font-nunitoSans leading-[27.28px] 3xl:leading-[38.19px] font-normal mb-10 text-[#E7E8EB]'>
              Get studio updates, exclusive offers, and podcasting tips straight
              to your inbox.
            </p>

            <form
              onSubmit={handleSubmit}
              className='flex flex-col font-nunitoSans text-xs lg:text-sm 3xl:text-base gap-4'
            >
              <input
                type='text'
                placeholder='Name'
              ...
              <div className='flex gap-2 relative'>
                <button
                  ...
                  className='flex gap-1 items-center  pr-3 3xl:pr-4 pl-4 3xl:pl-6 whitespace-nowrap rounded-md focus:outline-none focus:ring-2 focus:ring-orange-400 bg-white/10 text-white '
                >
                  <p className='self-stretch font-normal font-nunitoSans my-auto'>
                    {formData.countryCode}
                  </p>
                  {dropdownOpen ? (
                    <TbCaretUp className='size-5 text-white stroke-[1px]' />
                  ) : (
                    <TbCaretDown className='size-5 text-white stroke-[1px]' />
                  )}
                </button>
                {dropdownOpen && (
