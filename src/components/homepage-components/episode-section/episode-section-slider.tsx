...
const slides: SlideData[] = [
  ...
  // },
  {
    ...
    buttonText: 'Book Your Session',
    images: [
      '/images/episode-slides/slide-1.png',
      // '/images/studio4.jpg',
      // '/images/studio3.jpg',
    ],
    mobileImages: [
  ...
  },
  {
    ...
    buttonText: 'Book Your Session',
    images: [
        '/images/episode-slides/slide-2.png',
      // '/images/studio9.jpg',
      // '/images/studio2.jpg',
    ],
    mobileImages: [
...
//   const router = useRouter();
  ...
  const CalculateStyles = (index: number) => {
    ...
    return useSpring({
      to: {
        transform: `translateX(calc(${adjustedPosition * 75}% + ${
...
//   };
  ...
  return (
    ...
    >
      {/* Main Content */}
      <div className='absolute top-0 left-1/2 -translate-x-1/2 lg:w-[57%] w-[85%] h-[90%]'>
      ...
      {/* Slide Navigation */}
      <div className='lg:block hidden absolute z-40 bottom-0 w-[90%] lg:w-auto lg:right-10 flex justify-between lg:justify-end gap-2'>
        <button
...
export default EpisodeSectionSlider;
