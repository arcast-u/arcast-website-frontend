...
const NavigationBar = () => {
  ...
  const [isContactOpen, setIsContactOpen] = useState(pathname === '/contact'); // Initialize based on route
  ...
  useEffect(() => {
    setIsContactOpen(pathname === '/contact');
  }, [pathname]);
  ...
  useEffect(() => {
    ...
    const shouldOpenStudio = localStorage.getItem('openStudioDropdown') === 'true';
    if (shouldOpenStudio) {
      setIsStudioOpen(true);
    ...
    return () => {
      window.removeEventListener('openStudioDropdown', handleStudioDropdownEvent);
    };
  }, []);
  ...
  const handleDropdown = () => {
    ...
    // Don't toggle contact here as it's controlled by the route
  };
        ...
        >
          ...
          <ContactOverlay
            ...
            onClose={() => {
              ...
              if (pathname === '/contact') {
                router.push('/'); // Navigate away from /contact when closing
              }
            }}
          />
        </div>
