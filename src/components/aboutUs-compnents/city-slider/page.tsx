  ...
  return (
    <div className=' w-full 3xl:h-screen px-[21px] md:px-10 3xl:px-[100px] py-14 3xl:py-20'>
      <div className='h-full relative max-w-[1728px] overflow-hidden mx-auto'>
        <div className=''>
          <h2 className='text-[32px] leading-[41.7px] 3xl:text-5xl 3xl:leading-[62.54px] font-medium font-hankenGrotesk text-[#FCFCFC] mb-4'>
          ...
          <p className='mt-4 lg:w-[50%] 3xl:w-[45%] text-xl 3xl:text-[28px] leading-[27.28px] font-nunitoSans text-[#FCFCFC] 3xl:leading-[38.19px] font-normal mb-8'>
            We&apos;re not just building studios - we&apos;re creating the
            future of professional content creation, one space at a time.
          </p>
        </div>
              ...
              >
                <div className='relative h-[400px]'>
                  ...
                  <div className='absolute w-full flex justify-center  bottom-0 left-4'>
                    ...
                    >
                      <span className='text-orange-500'>ARcast</span>{' '}
                      {city.name}
                    </h3>
                  </div>
                </div>
        ...
        <div className='absolute bottom-0 w-full lg:w-auto lg:right-10 flex justify-between lg:justify-end gap-2'>
          <button
            ...
            onClick={prevSlide}
            className={`${
              index === 0 ? 'border-gray-700' : 'border-gray-500'
            } p-1 md:p-2 rounded-lg border-[1.5px]  shadow-sm `}
          >
          ...
          <button
            ...
            className={`${
              index === cities.length - 1
                ? 'border-gray-700'
                : 'border-gray-500'
            } p-1 md:p-2 rounded-lg border-[1.5px] border-gray-500 shadow-sm`}
          >
