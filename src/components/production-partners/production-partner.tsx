	...
	const teamMembers = [
		[
			...
			// },
			{
				...
				description:
					'Leads filming and editing with expert precision and creative direction.',
			},
			{
				...
				description:
					'Handles the technical expertise, ensuring flawless audio and video setup for every session.',
			},
		],
		[
			{
				...
				description:
					'Handles client bookings, scheduling, and team coordination, keeping every session organized and stress-free.',
			},
			{
				...
				title: 'Videographer',
				description:
					'Handles creative videography and is known to capture fresh, dynamic visuals.',
			},
		],
		[
			// {
