...
const Page = () => {
  ...
  return (
    <div className='bg-[#FCFCFC]'>
      ...
      <p className='px-[21px] md:px-0 md:w-[55%] mb-[34px] 3xl:mb-16 mx-auto text-center font-nunitoSans text-xl leading-[27.8px] 3xl:text[28px] 3xl:leading-10 text-[#333333]'>Bundle our most popular add-on services into packages that save you more. 
      ...
      {currentStep === 0 && <div className='w-full flex flex-col justify-center mb-10'>
      ...
      {currentStep === 1 && <div className='w-full flex flex-col justify-center mb-10'>
        <div className='my-8 3xl:my-[50px] gap-16 mx-auto flex items-center'>
      ...
      {currentStep === 2 && <div className='w-full flex flex-col justify-center mb-10'>
        <div className='my-8 3xl:my-[50px] gap-16 mx-auto flex items-center'>
