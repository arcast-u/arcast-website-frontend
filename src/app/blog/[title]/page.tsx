  ...
  return (
    <div className='  md:mb-[51px] lg:mb-0  3xl:mb-[120px] bg-[#fcfcfc]'>
      ...
      <div className='max-w-[1728px] mx-auto px-[21px] md:px-10 mt-[50px] 3xl:px-[100px]'>
        ...
        <h1 className='font-hankenGrotesk mt-[50px] lg:mt-10 text-[#333333] text-[32px] mb-6 3xl:mb-10 leading-[46.91px] 3xl:text-5xl 3xl:leading-[62.5px] font-semibold'>
        ...
        <div className='lg:pt-20 w-full pt-7 lg:mt-[50px] mt-7 border-t-[0.5px] border-[#989898]'>
          ...
          />
          <div className="w-full md:w-[70%] lg:w-[63%] 3xl:w-[748px] font-nunitoSans font-normal text-sm leading-5 lg:text-base lg:leading-[21.82px] mx-auto py-8 text-[#333333] space-y-12">
            {/* First paragraph */}
            ...
            <section className="space-y-6">
              <h2 className="text-xl leading-[27.28px] lg:text-2xl lg:leading-[32.74px] font-bold ">Introduction</h2>
              <p className="leading-relaxed">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur tempus urna at turpis condimentum lobortis.
              </p>
              <p className="leading-relaxed">
            ...
            {/* Conclusion Section */}
            <section className="space-y-6">
              <h2 className="text-xl leading-[27.28px] lg:text-2xl lg:leading-[32.74px] font-bold  ">Conclusion</h2>
              <p className="leading-relaxed">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Curabitur tempus urna at turpis condimentum lobortis.
              </p>
            </section>
        ...
        <p className='font-hankenGrotesk font-medium text-2xl leading-[31.2px] mb-8 3xl:mb-20 mt-[60px] 3xl:mt-80 3xl:text-[32px] 3xl:leading-[41.7px]'>Related Blogs</p>
