        ...
        <div className='py-6 px-[21px] md:px-10 3xl:px-[100px]'>
          ...
          <div className='font-nunitoSans'>
            ...
            <p className='text-base leading-6'>
              Welcome to Arcast. These Terms and Conditions govern your use of
            ...
            <p className='text-base leading-6'>
              ...
              equipment access, and professional recording assistance. All
              services are subject to availability and may be modified at our
              discretion.
            </p>
            ...
            <p className='text-base leading-6'>
              All fees for our services will be communicated to you prior to any
              transaction. Payments can be made through various methods as
              indicated on our website. Refunds and cancellations are subject to
              our refund policy.
            </p>
            ...
            <p className='text-base leading-6'>
              ...
              images, and videos, is the property of Arcast or its content
            ...
            <p className='text-base leading-6'>
              Arcast shall not be liable for any indirect, incidental, special,
              or consequential damages arising out of or in connection with the
              use of our services. We are not responsible for any loss of
              content, data, or production material resulting from your use of
              our services.
            </p>
