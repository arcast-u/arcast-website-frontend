...
const Page = () => {
  return (
    <div className='bg-[#FCFCFC]'>
      <NavigationBar/>
      <h1 className='mt-[100px] 3xl:mt-[134px] text-center mb-4 font-medium text-[32px] leading-[41.7px] 3xl:text-[64px] 3xl:leading-[83.39px] font-hankenGrotesk text-[#333333]'>Memberships</h1>
      ...
      <div className='px-[21px] flex flex-col justify-center'>
        <PricingTable/> 
      </div>
      <div className='bg-[#F5F5F7] px-[21px] mb-10 3xl:mb-20 py-10 3xl:pb-20 lg:px-10 3xl:px-[100px] '>
